...
def download_trades(symbol: str, no_days: int, download_dir : str = "data", cache_dir: str = "cache", return_trades=False) -> pl.DataFrame :
    """
...
def download_and_unzip(symbol : str, date: str | datetime, download_dir: str = "data", cache_dir: str = "cache") -> pl.DataFrame:
    ...
    """
    Download and unzip Binanace futures trade data for a given symbol and date.
...
def download_date_range(symbol: str, start_date: str | datetime, end_date: str | datetime, download_dir: str = "data", cache_dir: str = "cache") -> list[pl.DataFrame]:
